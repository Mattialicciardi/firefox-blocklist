...
~/Desktop è iCloud-synced e `codesign` fallirebbe) è **obbligatoria** perché il
grant App Management si agganci.
...
Se una PR tocca `apply()` o la firma in `scripts/install.sh`, evidenzialo nella
